...
async def handle_update(update: dict[str, Any]) -> None:
    ...
    if settings.admin_user_ids and str(user_id) not in {str(x) for x in settings.admin_user_ids}:
        await telegram.send_message(chat_id, "У тебя нет доступа к этому боту.")
        return
